...
def wavelet_analysis(ppg_signal, fps, wavelet=None):
    ...
    min_scale = min_freq_hz/2  # 스케일 하한
    max_scale = fps/2  # 스케일 상한
    sampling_period = 1/fps  # 샘플링 주기
    scales = np.arange(min_scale, max_scale, 2**0.03125)  # 스케일 배열
